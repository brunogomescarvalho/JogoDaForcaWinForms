namespace JogoDaForcaWinFormsApp
{
    partial class Form1
    {
        ...
        {
            caracteres = new TableLayoutPanel();
            buttonZ = new Button();
            ...
            buttonIComAcento = new Button();
            buttonOComAcento = new Button();
            buttonUComAcento = new Button();
            buttonCCedilha = new Button();
            ...
            caracteres.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            caracteres.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            caracteres.Controls.Add(buttonZ, 0, 5);
            caracteres.Controls.Add(bntIniciar, 4, 5);
            caracteres.Controls.Add(buttonA, 0, 0);
            caracteres.Controls.Add(buttonB, 1, 0);
            caracteres.Controls.Add(buttonC, 2, 0);
            caracteres.Controls.Add(buttonD, 3, 0);
            caracteres.Controls.Add(buttonE, 4, 0);
            caracteres.Controls.Add(buttonF, 0, 1);
            caracteres.Controls.Add(buttonG, 1, 1);
            caracteres.Controls.Add(buttonH, 2, 1);
            caracteres.Controls.Add(buttonI, 3, 1);
            caracteres.Controls.Add(buttonJ, 4, 1);
            caracteres.Controls.Add(buttonK, 0, 2);
            caracteres.Controls.Add(buttonL, 1, 2);
            caracteres.Controls.Add(buttonM, 2, 2);
            caracteres.Controls.Add(buttonN, 3, 2);
            caracteres.Controls.Add(buttonO, 4, 2);
            caracteres.Controls.Add(buttonP, 0, 3);
            caracteres.Controls.Add(buttonQ, 1, 3);
            caracteres.Controls.Add(buttonR, 2, 3);
            caracteres.Controls.Add(buttonS, 3, 3);
            caracteres.Controls.Add(buttonT, 4, 3);
            caracteres.Controls.Add(buttonU, 0, 4);
            caracteres.Controls.Add(buttonV, 1, 4);
            caracteres.Controls.Add(buttonW, 2, 4);
            ...
            // bntIniciar
            // 
            bntIniciar.BackColor = SystemColors.MenuHighlight;
            ...
            // caracteresEspeciais
            // 
            caracteresEspeciais.ColumnCount = 3;
            caracteresEspeciais.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 33.3333321F));
            caracteresEspeciais.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 34.52381F));
            caracteresEspeciais.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 32.4404755F));
            caracteresEspeciais.Controls.Add(buttonAComAcento, 0, 0);
            caracteresEspeciais.Controls.Add(buttonEComAcento, 1, 0);
            caracteresEspeciais.Controls.Add(buttonIComAcento, 2, 0);
            caracteresEspeciais.Controls.Add(buttonOComAcento, 0, 1);
            caracteresEspeciais.Controls.Add(buttonUComAcento, 1, 1);
            caracteresEspeciais.Controls.Add(buttonCCedilha, 2, 1);
            ...
            caracteresEspeciais.RowStyles.Add(new RowStyle(SizeType.Percent, 33.3333321F));
            caracteresEspeciais.RowStyles.Add(new RowStyle(SizeType.Percent, 33.3333321F));
            caracteresEspeciais.Size = new Size(336, 215);
            caracteresEspeciais.TabIndex = 8;
            caracteresEspeciais.Visible = false;
            // 
            // buttonAComAcento
            // 
            buttonAComAcento.Dock = DockStyle.Fill;
            buttonAComAcento.Font = new Font("Segoe UI", 19F, FontStyle.Regular, GraphicsUnit.Point);
            buttonAComAcento.Location = new Point(3, 3);
            buttonAComAcento.Name = "buttonAComAcento";
            buttonAComAcento.Size = new Size(105, 65);
            buttonAComAcento.TabIndex = 0;
            buttonAComAcento.Text = "Á";
            buttonAComAcento.UseVisualStyleBackColor = true;
            // 
            // buttonEComAcento
            // 
            ...
            buttonEComAcento.Text = "É";
            buttonEComAcento.UseVisualStyleBackColor = true;
            // 
            // buttonIComAcento
            // 
            buttonIComAcento.Dock = DockStyle.Fill;
            buttonIComAcento.Font = new Font("Segoe UI", 19F, FontStyle.Regular, GraphicsUnit.Point);
            buttonIComAcento.Location = new Point(229, 3);
            buttonIComAcento.Name = "buttonIComAcento";
            buttonIComAcento.Size = new Size(104, 65);
            buttonIComAcento.TabIndex = 2;
            buttonIComAcento.Text = "Í";
            buttonIComAcento.UseVisualStyleBackColor = true;
            // 
            // buttonOComAcento
            // 
            buttonOComAcento.Dock = DockStyle.Fill;
            buttonOComAcento.Font = new Font("Segoe UI", 19F, FontStyle.Regular, GraphicsUnit.Point);
            buttonOComAcento.Location = new Point(3, 74);
            buttonOComAcento.Name = "buttonOComAcento";
            buttonOComAcento.Size = new Size(105, 65);
            buttonOComAcento.TabIndex = 3;
            buttonOComAcento.Text = "Ó";
            buttonOComAcento.UseVisualStyleBackColor = true;
            // 
            // buttonUComAcento
            // 
            buttonUComAcento.Dock = DockStyle.Fill;
            buttonUComAcento.Font = new Font("Segoe UI", 19F, FontStyle.Regular, GraphicsUnit.Point);
            buttonUComAcento.Location = new Point(114, 74);
            buttonUComAcento.Name = "buttonUComAcento";
            buttonUComAcento.Size = new Size(109, 65);
            buttonUComAcento.TabIndex = 4;
            buttonUComAcento.Text = "Ú";
            buttonUComAcento.UseVisualStyleBackColor = true;
            // 
            // buttonCCedilha
            // 
            buttonCCedilha.Dock = DockStyle.Fill;
            buttonCCedilha.Font = new Font("Segoe UI", 19F, FontStyle.Regular, GraphicsUnit.Point);
            buttonCCedilha.Location = new Point(229, 74);
            buttonCCedilha.Name = "buttonCCedilha";
            buttonCCedilha.Size = new Size(104, 65);
            buttonCCedilha.TabIndex = 5;
            buttonCCedilha.Text = "Ç";
            buttonCCedilha.UseVisualStyleBackColor = true;
            // 
            ...
            // buttonAComTil
            // 
            buttonAComTil.Dock = DockStyle.Fill;
            buttonAComTil.Font = new Font("Segoe UI", 19F, FontStyle.Regular, GraphicsUnit.Point);
            buttonAComTil.Location = new Point(114, 145);
            buttonAComTil.Name = "buttonAComTil";
            buttonAComTil.Size = new Size(109, 67);
            buttonAComTil.TabIndex = 7;
            buttonAComTil.Text = "Ã";
            buttonAComTil.UseVisualStyleBackColor = true;
            // 
            // buttonOComTil
            // 
            buttonOComTil.Dock = DockStyle.Fill;
            buttonOComTil.Font = new Font("Segoe UI", 19F, FontStyle.Regular, GraphicsUnit.Point);
            buttonOComTil.Location = new Point(229, 145);
            buttonOComTil.Name = "buttonOComTil";
            buttonOComTil.Size = new Size(104, 67);
            buttonOComTil.TabIndex = 8;
        ...
        #endregion
        private TableLayoutPanel caracteres;
        ...
        private Button buttonEComAcento;
        private Button buttonIComAcento;
        private Button buttonOComAcento;
        private Button buttonUComAcento;
        private Button buttonCCedilha;
